...
[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-python/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-python/actions/workflows/validate.yml)

Neovim tree-sitter queries for **python**, part of the
...
- [ ] Changes are scoped to `python` — do not include files for other languages
